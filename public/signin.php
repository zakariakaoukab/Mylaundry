...
<body class="h-full" id="style-4">
  <div class="wrapper">
    ...
    <nav class="p-5 bg-white shadow md:flex md:items-center md:justify-between ">
      ...
      <ul id="navMenu" class="md:flex md:items-center z-10 md:z-auto md:static absolute bg-white w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-500">
