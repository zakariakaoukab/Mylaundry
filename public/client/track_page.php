...
<nav class="p-2.5 bg-white shadow-md md:flex md:items-center md:justify-between relative z-10">
  ...
  <div class="w-full max-w-7xl px-6">
        <h2 class="px-4 py-4 text-2xl font-bold text-gray-800 mb-4">Order Details </h2>
        ...
        $user_id = $_SESSION['auth_user']['id_user'];
         ...
         $query = "
         SELECT o.order_id, o.order_date, o.pickupDate, o.deliveryDate, o.total, o.status, 
                od.article_id, od.quantity, od.price AS order_detail_price,
                a.article_name, a.price AS article_price
         FROM orders o
     ...
     if ($result->num_rows > 0): ?>
         <div class="overflow-x-auto">
             <table class="w-full bg-white shadow-lg rounded-lg border border-gray-200">
                 <thead>
                     <tr>
                         <th class="py-3 px-6 bg-gray-200 font-bold uppercase text-sm text-gray-600 border-b border-gray-200 text-center">Order ID</th>
                         <th class="py-3 px-6 bg-gray-200 font-bold uppercase text-sm text-gray-600 border-b border-gray-200 text-center">Order Date</th>
                         <th class="py-3 px-6 bg-gray-200 font-bold uppercase text-sm text-gray-600 border-b border-gray-200 text-center">Pickup Date</th>
                         <th class="py-3 px-6 bg-gray-200 font-bold uppercase text-sm text-gray-600 border-b border-gray-200 text-center">Delivery Date</th>
                         <th class="py-3 px-6 bg-gray-200 font-bold uppercase text-sm text-gray-600 border-b border-gray-200 text-center">Articles</th>
                         <th class="py-3 px-6 bg-gray-200 font-bold uppercase text-sm text-gray-600 border-b border-gray-200 text-center">Total</th>
                         <th class="py-3 px-6 bg-gray-200 font-bold uppercase text-sm text-gray-600 border-b border-gray-200 text-center">Status</th>
                     </tr>
                 </thead>
                 <tbody>
                     <?php 
                     ...
                     while ($row = $result->fetch_assoc()) {
                         ...
                         $orders[$current_order_id]['articles'][] = [
                     ...
                     foreach ($orders as $order): ?>
                         <tr class="hover:bg-gray-100">
                             <td class="py-4 px-6 border-b border-gray-200 text-center"><?php echo $order['order_id']; ?></td>
                             <td class="py-4 px-6 border-b border-gray-200 text-center"><?php echo $order['order_date']; ?></td>
                             <td class="py-4 px-6 border-b border-gray-200 text-center"><?php echo $order['pickupDate']; ?></td>
                             <td class="py-4 px-6 border-b border-gray-200 text-center"><?php echo $order['deliveryDate']; ?></td>
                             <td class="py-4 px-6 border-b border-gray-200">
                                 <ul class="max-w-md space-y-1 text-gray-500 list-none list-inside dark:text-gray-400">
                                     <?php foreach ($order['articles'] as $article): ?>
                                         <li><?php echo $article['article_name'] . ' (x' . $article['quantity'] . ') -  ' . $article['price'] .'DH'; ?></li>
                                     <?php endforeach; ?>
                                 </ul>
                             </td>
                             <td class="font-bold py-4 px-6 border-b border-gray-200 text-center"><?php echo $order['total']; ?>DH</td>
                             <td class="py-4 px-6 border-b border-gray-200 text-center">
                                 <span class="px-4 py-2 font-semibold leading-tight <?php echo $order['status'] === 'Delivered' ? 'text-green-700 bg-green-100' : 'text-yellow-700 bg-yellow-100'; ?> rounded-full"><?php echo $order['status']; ?></span>
                             </td>
                         </tr>
                     <?php endforeach; ?>
                 </tbody>
     ...
     <?php else: ?>
         <p class="px-4 py-4 text-lg text-gray-600">No orders found.</p>
     <?php endif;
