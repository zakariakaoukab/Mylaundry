...
<nav class="p-2.5 bg-white shadow-md md:flex md:items-center md:justify-between fixed top-0 w-full z-10 ">
  ...
  <div style="margin-top:6rem;">
    <h1 class="text-center text-5xl	 font-bold mt-1 mb-1">Profile</h1>
  </div>
    ...
    <div>
      ...
      <form   method="post" action="update-user.php">
        ...
        <div class="flex flex-col mt-2">
          <label for="fname" class="text-lg font-bold">First name :</label>
          <input type="text" name="cycle" id="cycle"  class="h-14 border border-gray-200 p-4" style="background-color: #DFF6FF; border-radius: 9999px;" value="<?php echo $user['fname'];?>" >
        </div>
        <div class="flex flex-col mt-2">
        <label for="lname" class="text-lg font-bold">Last name:</label>
        <input type="text" name="lname" id="lname" class="h-14 border border-gray-200 p-4" style="background-color: #DFF6FF; border-radius: 9999px;" value="<?php echo $user['lname'];?>">
    </div>
    <div class="flex flex-col mt-2">
        <label for="email" class="text-lg font-bold">Email:</label>
        <input type="email" name="email" id="email" class="h-14 border border-gray-200 p-4" style="background-color: #DFF6FF; border-radius: 9999px;" value="<?php echo $user['email'];?>">
    </div>
    <div class="flex flex-col mt-2">
        <label for="phone" class="text-lg font-bold">Phone:</label>
        <input type="text" name="phone" id="phone" class="h-14 border border-gray-200 p-4" style="background-color: #DFF6FF; border-radius: 9999px;" value="<?php echo $user['phone'];?>">
    </div>
    &nbsp;<hr class="css-5t036d">
    <div class="flex flex-col mt-2">
        <label for="street" class="text-lg font-bold">Street:</label>
        <input type="text" name="street" id="street" class="h-14 border border-gray-200 p-4" style="background-color: #DFF6FF; border-radius: 9999px;" value="<?php echo $user['street'];?>">
    </div>
    <div class="flex flex-row mt-2">
        <div class="flex flex-col mr-2">
            <label for="city" class="text-lg font-bold">City:</label>
            <input type="text" name="city" id="city" class="h-14 border border-gray-200 p-4" style="background-color: #DFF6FF; border-radius: 9999px;" value="<?php echo $user['city'];?>">
        </div>
        <div class="flex flex-col">
            <label for="zip" class="text-lg font-bold">ZIP code:</label>
            <input type="text" name="zip" id="zip" class="h-14 border border-gray-200 p-4" style="background-color: #DFF6FF; border-radius: 9999px;" value="<?php echo $user['zip'];?>">
        </div>
    </div>
    <div class=" flex flex-col items-center mt-5 mb-10 space-y-2">
    <div>
        <button type="submit" class="font-bold text-white bg-[#050708] hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 rounded-lg text-xl px-8 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 me-2 mb-2">
            <span class="font-mono mr-2">Update</span> 
  ...
  <button type="button" class="font-bold text-white bg-[#050708] hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 rounded-lg text-xl px-8 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 me-2 mb-2">
            <span class="font-mono mr-2">Change Password</span> 
            <svg width="23px" height="23px" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M0 0h192v192H0z" style="fill:none"></path><circle cx="96" cy="96" r="67" style="stroke:#ffffff;stroke-width:12px;stroke-miterlimit:10;fill:none"></circle><path d="M106.84 103.05C112.93 99.37 117 92.69 117 85.06c0-11.6-9.4-21-21-21s-21 9.4-21 21c0 7.63 4.07 14.31 10.16 17.99L75 127.93h42l-10.16-24.88Z" style="stroke-linejoin:round;stroke:#ffffff;stroke-width:12px;fill:none"></path><path d="m22 22 26 26m96 96 26 26m-148 0 26-26m96-96 26-26" style="fill:none;stroke-linecap:round;stroke-miterlimit:10;stroke:#ffffff;stroke-width:12px"></path></g></svg>      
